...
#define RS_VAL_NAN_VI_INT32			0x80000000
...
/******************************************************************************************************
 ...
 if True, it signals a call from the end user. End-user cannot call Set/Get/Check attribute with this flag set to false
 If False, it signals a call from inside the driver, where you can also Set/Get/Check
 the attributes with flags RS_VAL_NOT_USER_READABLE, RS_VAL_NOT_USER_WRITABLE, RS_VAL_HIDDEN
 In addition, False also means blocking of the StatusCheck procedure
******************************************************************************************************/
...
ViStatus RsCore_QueryAndParseIDNstring(ViSession instrSession,
                                       ViAttr idnStringAttributeId,
                                       ViString simulationIDNstring,
                                       ViBoolean idnModelFullName,
                                       ViString customScanString);
...
ViStatus RsCore_StrCatDynamicViBoolean(ViSession instrSession, ViChar** target, ViConstString append1, ViBoolean valueToAppend,
...
ViStatus RsCore_SpecialCallback_SurroundParamWrite(ViSession instrSession, ViConstString repCapName, RsCoreAttributePtr attr, ViConstString beforeParam, void* value, ViConstString afterParam);
