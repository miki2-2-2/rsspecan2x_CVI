...
static ViString tetraMeasurementSelectArr[] = {
	"PvsT", "EVMSYMbol", "EVMCARrier", "MAGNitude", "PHASe", "SPECFFT", "SPECACPMod", "SPECACPUpp", "SPECACPLow", "CONSSYMbol", "CONSCarrier", "STATistics", "SUMTable", NULL
};
static ViString tetraYAxisMeasArr[] = {"ECarrier", "ESymbol", "Magnitude", "Phase"};
static ViString tetraSummaryTableArr[] = {
	"EVMAll", "EVMData", "EVMDHEAder", "EVMDSPilot", "EVMSPILot", "IQOFfset", "GIMBalance", "QUADerror", "AMPDroop", "FERRor", "PHASeerror", "MAGerror", "BPWR", "CRESt", NULL
};
...
)
{
	...
	{
		snprintf(repCap, RS_REPCAP_BUF_SIZE, "ACP%s,ACP%s,%s,TETRA%s", tetraACPTypeArr[acp], tetraACPChannelArr[channelNumber], tetraACPMeas[acpMeasurement],
