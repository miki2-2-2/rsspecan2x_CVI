...
ViStatus _VI_FUNC rsspecan_BTOMode (ViSession instrSession)
{
    ...
    viCheckErr( rsspecan_SetAttributeViString (instrSession, "", RSSPECAN_ATTR_BTO_MODE, ""));
                                           ...
                                           ViInt32 trace)
{
    ...
    checkErr( Rs_LockSession (instrSession, VI_NULL));
    if (rsspecan_invalidViInt32Range (trace, 1, 3))
    {
        viCheckParm (RS_ERROR_INVALID_PARAMETER, 2, "Trace");
    }
    
    sprintf (buffer, "TR%ld", trace);
    viCheckErr(rsspecan_SetAttributeViString(instrSession, buffer, RSSPECAN_ATTR_BTO_TRAC, ""));
                                                    ...
                                                    ViReal64 anntennaGain)
{
    ...
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_GEOG, 
                                  geographicalRegion), 2, "Geographical Region");
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_CHANNEL, 
                                                channel), 3, "Channel");  
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_PCL, 
                                                outputPowerClass), 4, "Output Power Class");                                                  
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_PRAT,  
                                  samplesPerSymbols), 5, "Samples Per Symbol");                                  
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_PTYPE, 
                                  packetType), 6, "Packet Type");                                  
    viCheckParm( rsspecan_SetAttributeViReal64 (instrSession, "", RSSPECAN_ATTR_BTO_EGA_INP, 
                                  anntennaGain), 7, "Antenna Gain");                                   
                                                        ...
                                                        ViReal64 stopPosition)
{
    ...
    viCheckParm( rsspecan_SetAttributeViReal64 (instrSession, "Start", RSSPECAN_ATTR_BTO_POW_AVER,
                                  startPosition), 2, "Start Position");
    viCheckParm( rsspecan_SetAttributeViReal64 (instrSession, "Stop", RSSPECAN_ATTR_BTO_POW_AVER,
                                  stopPosition), 2, "Stop Position");
                                                        ...
                                                        ViReal64 searchLength)
{
    ...
    viCheckParm( rsspecan_SetAttributeViBoolean (instrSession, "", RSSPECAN_ATTR_BTO_SEARCH_SYNC,  
                                  findSync), 2, "Find Sync");
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_SYNC_OFFS,  
                                  syncOffset), 3, "Sync Offset");                                  
    viCheckParm( rsspecan_SetAttributeViBoolean (instrSession, "", RSSPECAN_ATTR_BTO_SEARCH_PULS,  
                                  findBurst), 4, "Find Burst");                                  
    viCheckParm( rsspecan_SetAttributeViReal64 (instrSession, "", RSSPECAN_ATTR_BTO_PULS_OFFS,  
                                  burstOffset), 5, "Burst Offset");
    viCheckParm( rsspecan_SetAttributeViBoolean (instrSession, "", RSSPECAN_ATTR_BTO_SEARCH_TIME_AUTO,  
                                  searchLengthAuto), 6, "Search Length Auto");   
    if (!searchLengthAuto)
    {
        viCheckParm( rsspecan_SetAttributeViReal64 (instrSession, "", RSSPECAN_ATTR_BTO_SEARCH_TIME,  
                                  searchLength), 7, "Search Length");                                       
    }                                  
                                                        ...
                                                        ViInt32 lowest24Bits_ofDevAddress)
{
    ...
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_LAP, 
                                  lowest24Bits_ofDevAddress), 2, 
                                  "Lowest 24 Bits of Dev. Address");
                                                        ...
                                                        ViInt32 measurementMode)
{
    ...
    {
        if (rsspecan_invalidViInt32Range (measurementMode, 0, 4) == VI_TRUE)
        {
            viCheckParm (RS_ERROR_INVALID_PARAMETER, 2, "Measurement Mode");
        }
    }
    
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO,
                                               measurementMode), 2,"Measurement Mode");
                                                               ...
                                                               ViInt32 number_ofAdjacentChannels)
{
    ...
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_ACLR_ACP,
                                               number_ofAdjacentChannels), 2,"Number of Adjacent Channels");
                                                      ...
                                                      ViInt32 filter)
{
    ...
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_FILT_MEAS,
                                  filter), 2 , "Filter");                                                 
                                                    ...
                                                    ViInt32 numberOfSweeps)
{
    ...
    viCheckParm( rsspecan_SetAttributeViBoolean (instrSession, "Win1", 
                                              ...
                                              ViInt32 traceDetector)
{
    ...
    sprintf (buffer, "TR%ld", trace);
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, buffer, RSSPECAN_ATTR_BTO_TRAC_MOD,
                                              traceMode), 3,"Trace Mode");
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, buffer, RSSPECAN_ATTR_BTO_TRAC_DET,
                                               traceDetector), 4,"Trace Detector");
                                                       ...
                                                       ViInt32 packetBytesSCO)
{
    ...
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_PBSC,
                                              packetBytesSCO), 2,"Packet Bytes SCO");
                                                            ...
                                                            ViReal64 scaling)
{
    ...
    viCheckParm( rsspecan_SetAttributeViReal64 (instrSession, "", RSSPECAN_ATTR_BTO_PDIV,
                                              scaling), 2,"Scaling");
                                                               ...
                                                               ViReal64 startTime)
{
    ...
    viCheckParm( rsspecan_SetAttributeViBoolean (instrSession, "", RSSPECAN_ATTR_BTO_ZOOM_STATE,
                                              zoomState), 2,"Zoom State");
    if (zoomState == VI_TRUE)
    {
        viCheckParm( rsspecan_SetAttributeViReal64 (instrSession, "", RSSPECAN_ATTR_BTO_ZOOM_START,
                                                   ...
                                                   ViInt32 *status)
{
    ...
    viCheckParm (rsspecan_GetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_STAT, status), 2, "Status");
                                             ...
                                             ViInt32 *type, ViInt32 *length)
{
    ...
    viCheckParm (rsspecan_GetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_PTYP, type), 2, "Type");
    viCheckParm (rsspecan_GetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_PLEN, length), 3, "Length");
                                              ...
                                              ViReal64 *power)
{
    ...
    if ( (type<RSSPECAN_VAL_MEASTYPE_MIN) || (type>RSSPECAN_VAL_MEASTYPE_PEAK) )
                                                  ...
                                                  ViInt32 *returnedValues)
{
    ...
    viCheckErr (rsspecan_GetAttributeViString (instrSession, "", RS_ATTR_OPTIONS_LIST, RSSPECAN_IO_BUFFER_SIZE, buffer));
    ...
    if (!power)
        viCheckParm( RS_ERROR_INVALID_PARAMETER, 3, "Power List"); 
    
    viCheckErr( viPrintf (instrSession,":CALC:BTO:ACLR:LIST?\n")); 
                                                     ...
                                                     ViReal64 *value)
{
    ...
    if ( (type<RSSPECAN_VAL_MEASTYPE_MAXMIN) || (type>RSSPECAN_VAL_MEASTYPE_AVERMAX) )
                                                      ...
                                                      ViReal64 *value)
{
    ...
    viCheckParm (rsspecan_GetAttributeViReal64 (instrSession, "", RSSPECAN_ATTR_BTO_MCH_DF2_PERC,
                                                value), 2, "Value");
                                                 ...
                                                 ViReal64 values[])
{
    ...
    if (rsspecan_invalidViUInt32Range (maximumTime, 0, 4294967295UL) == VI_TRUE)
        viCheckParm (RS_ERROR_INVALID_PARAMETER, 2, "Maximum Time");         
       
    viCheckErr (rsspecan_dataReadTrace (instrSession, 0, "BTOB", arrayLength, 
                    values, actualPoints));
                                           ...
                                           ViReal64 amplitude[])
{
    ...
    viCheckErr (rsspecan_dataReadTrace (instrSession, 0, "BTOF", arrayLength, 
...
{    
    ...
    viCheckErr (rsspecan_SetAttributeViString (instrSession, "", RSSPECAN_ATTR_BTO_IBS_GATE_AUTO, NULL));
                                                          ...
                                                          ViInt32 *returnedValues)
{
    ...
    viCheckErr( viPrintf (instrSession,":CALC:BTO:IBS?\n")); 
    viCheckErr (Rs_ReadDataUnknownLength (instrSession, &pbuffer, VI_NULL)); 
    pstring_value = strtok(pbuffer, ",");
                                                       ...
                                                       ViInt32 *exceptions)
{
    ...
    viCheckParm( rsspecan_GetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_IBS_EXC,
                                                      ...
                                                      ViInt32 blockCount)
{
    ...
    viCheckParm( rsspecan_SetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_CFST_BLOCK_COUNT,
                                  blockCount), 2 , "Block Count");                                                 
                                                             ...
                                                             ViReal64 *value)
{
    ...
    switch (parameter){ 
        case RSSPECAN_VAL_BTO_CFS_FERR_INITIAL: 
            viCheckParm( rsspecan_GetAttributeViReal64 (instrSession, buffer, RSSPECAN_ATTR_BTO_CFST_FERR_INITIAL,
                                  value), 4 , "Value");                                                 
        break;
        case RSSPECAN_VAL_BTO_CFS_FERR_BLOCK:   
            viCheckParm( rsspecan_GetAttributeViReal64 (instrSession, buffer, RSSPECAN_ATTR_BTO_CFST_FERR_BLOCK,
                                  value), 4 , "Value");                                                 
        break;
        case RSSPECAN_VAL_BTO_CFS_FERR_TOTAL:   
            viCheckParm( rsspecan_GetAttributeViReal64 (instrSession, buffer, RSSPECAN_ATTR_BTO_CFST_FERR_TOTAL,
                                  value), 4 , "Value");                                                 
        break;
        default:
            viCheckParm (RS_ERROR_INVALID_PARAMETER, 2, "Parameter"); 
                                                                 ...
                                                                 ViReal64 *value)
{
    ...
    switch (parameter){ 
        case RSSPECAN_VAL_BTO_CFS_DEVM_RMS: 
            viCheckParm( rsspecan_GetAttributeViReal64 (instrSession, buffer, RSSPECAN_ATTR_BTO_CFST_DEVM_RMS,
                                  value), 4 , "Value");                                                 
        break;
        case RSSPECAN_VAL_BTO_CFS_DEVM_99PCT:   
            viCheckParm( rsspecan_GetAttributeViReal64 (instrSession, "", RSSPECAN_ATTR_BTO_CFST_DEVM_99PCT,
                                  value), 4 , "Value");                                                 
        break;
        case RSSPECAN_VAL_BTO_CFS_DEVM_PEAK:    
            viCheckParm( rsspecan_GetAttributeViReal64 (instrSession, "", RSSPECAN_ATTR_BTO_CFST_DEVM_PEAK,
                                  value), 4 , "Value");                                                 
        break;
        default:
            viCheckParm (RS_ERROR_INVALID_PARAMETER, 2, "Parameter"); 
                                                                  ...
                                                                  ViInt32 *value)
{
    ...
    switch (parameter){ 
        case RSSPECAN_VAL_BTO_DPEN_TESTED:  
            viCheckParm( rsspecan_GetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_DPEN_PACKETS,
                                  value), 4 , "Value");                                                 
        break;
        case RSSPECAN_VAL_BTO_DPEN_BER: 
            viCheckParm( rsspecan_GetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_DPEN_BER,
                                  value), 4 , "Value");                                                 
        break;
        case RSSPECAN_VAL_BTO_DPEN_PASSED:  
            viCheckParm( rsspecan_GetAttributeViInt32 (instrSession, "", RSSPECAN_ATTR_BTO_DPEN_PACKETS_PASSED,
                                  value), 4 , "Value");                                                 
        break;
        default:
            viCheckParm (RS_ERROR_INVALID_PARAMETER, 2, "Parameter"); 
                                                            ...
                                                            ViReal64 stop)
{
    ...
    switch (packetSection){
        case RSSPECAN_VAL_BTO_RTP_GFSK:
            viCheckParm( rsspecan_SetAttributeViReal64 (instrSession, "SECTION_TIME_GFSK,Start", RSSPECAN_ATTR_BTO_RTP_TIME,
                                  start), 3 , "Start");                                                 
            viCheckParm( rsspecan_SetAttributeViReal64 (instrSession, "SECTION_TIME_GFSK,Stop", RSSPECAN_ATTR_BTO_RTP_TIME,
                                  stop), 4 , "Stop");   
        break;
        case RSSPECAN_VAL_BTO_RTP_DPSK:
            viCheckParm( rsspecan_SetAttributeViReal64 (instrSession, "SECTION_TIME_DPSK,Start", RSSPECAN_ATTR_BTO_RTP_TIME,
                                  start), 3 , "Start");                                                 
            viCheckParm( rsspecan_SetAttributeViReal64 (instrSession, "SECTION_TIME_DPSK,Stop", RSSPECAN_ATTR_BTO_RTP_TIME,
                                  stop), 4 , "Stop");   
        break;
        default:
            viCheckParm (RS_ERROR_INVALID_PARAMETER, 2, "Packet Section");    
    }
                                                            ...
                                                            ViReal64 *value)
{
    ...
    switch (modificator){
        ...
        break;
        default:
            viCheckParm (RS_ERROR_INVALID_PARAMETER, 3, "Modificator");  
    }       
    switch (parameter){ 
        case RSSPECAN_VAL_BTO_RTP_DPSK:
            strcat(buffer,"SECTION_DPSK");
            viCheckParm( rsspecan_GetAttributeViReal64 (instrSession, buffer, RSSPECAN_ATTR_BTO_RTP,
                                  value), 4 , "Value");                                                 
        break;
        case RSSPECAN_VAL_BTO_RTP_GFSK:
        ...
        case RSSPECAN_VAL_BTO_RTP_RATIO:    
            viCheckParm( rsspecan_GetAttributeViReal64 (instrSession, buffer, RSSPECAN_ATTR_BTO_RTP_RATIO,
                                  value), 4 , "Value");                                                 
        break;
        default:
            viCheckParm (RS_ERROR_INVALID_PARAMETER, 2, "Parameter"); 
