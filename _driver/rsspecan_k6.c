                                                            ...
                                                            ViInt32 scaling)
{
    ...
    checkErr(RsCore_CheckInstrumentOptions(instrSession, "K6"));viCheckParm(RsCore_InvalidViInt32Range(instrSession, parameter, RSSPECAN_VAL_PULSE_RESULT_TIMING_ALL, RSSPECAN_VAL_PULSE_RESULT_TIMING_PRF),
		3, "Parameter");
                                                               ...
                                                               ViInt32 scaling)
{
    ...
    checkErr(RsCore_CheckInstrumentOptions(instrSession, "K6"));viCheckParm(RsCore_InvalidViInt32Range(instrSession, parameter, RSSPECAN_VAL_PULSE_RESULT_FREQ_ALL, RSSPECAN_VAL_PULSE_RESULT_FREQ_CRAT),
		3, "Parameter");
	viCheckParm(RsCore_InvalidViInt32Range(instrSession, scaling, RSSPECAN_VAL_PULSE_RESULT_FREQ_SCALING_HZ_NS, RSSPECAN_VAL_PULSE_RESULT_FREQ_SCALING_GHZ_S),
			5, "Scaling");
