...
#include "rsspecan.h"
static ViString trace3GUEArr[] = {
	"TRACE1", "TRACE1", "TRACE1", "TRACE1", "CTAB", "TRACE2", "TRACE2", "TRACE2",
	"TRACE2", "ABIT", "TRACE2", "TRACE2", "TRACE2", "TRACE2", "TRACE2", "TRACE2", "TRACE2",
	"TRACE2", "TRACE2", "TRACE2", "TRACE2", "CEVM"
};
static ViString result3GUECDPArr[] = {
	"PTOT", "FERR", "TFR", "MACC",
                                                              ...
                                                              ViReal64 cdpRelative[])
{
	...
	for (i = 1; i < arraySize; i++)
		pbuffer += sprintf(pbuffer, ",%ld,%ld,%ld,%ld,%d,%.12f",
		                   codeClass[i], codeNumber[i], channelMapping[i], pilotLength[i], status[i] == VI_FALSE ? 0 : 1, cdpRelative[i]);
                                                             ...
                                                             ViChar channelTablesList[])
{
	...
	checkErr(RsCore_QueryCatalog(instrSession, ":CONF:WCDP:MS:CTAB:CAT?", bufferSize, channelTablesList, numberofChannelTables));
