...
)
{
	ViStatus error = VI_SUCCESS;
	ViAttr attr[2][2] = {
		{RSSPECAN_ATTR_NOISE_UNCERTAINTY_DUT_INPUT_VSWR, RSSPECAN_ATTR_NOISE_UNCERTAINTY_DUT_INPUT_RETURN_LOSS},
                                                            ...
                                                            ViReal64* uncertainty)
{
	ViStatus error = VI_SUCCESS;
	ViAttr attr[] = {
		RSSPECAN_ATTR_SPEC_ANALYZER_UNCERTAINTY_GAIN,
